...
run_perf() {
    ...
    echo "$dataset,$execution,$mem_ratio,$cpu_cycles,$instructions,$cache_misses,$cache_references,$branch_misses,$page_faults,$llc_load_misses,$llc_store_misses,$cas_count_read,$cas_count_write,$cpu_utilization,$time_taken" >> "$output_file"
}
